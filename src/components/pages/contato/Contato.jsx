                        ...
                        <div className="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-1 col-sm-6">
                            <article className="pagina-artigo">
                                <div className="pagina-contato-texto">
                                    <p>A Sennda Software tem 10 anos de experiência no mercado,
                                        além de uma atuação expressiva na área de softwares para gestão comercial e suporte técnico na área de TI.
                                        Endereço :
                                        <br></br>
                                        Av Lúcio Meira, 670 – Várzea Shopping, Sala 622 – Centro – Teresópolis – RJ
                                    </p>
                                    <br></br>
                                    <p>CEP: 25953-007</p>
                                    <p>
